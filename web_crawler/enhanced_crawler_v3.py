...
class EnhancedCompetitionCrawlerV3:
    ...
    def __init__(self, use_dynamic: bool = False, timeout: int = 30, 
                 ...
                 max_retries: int = 3, auto_remove_failed: bool = True,
                 urls_file: str = "urls.csv", output_dir: str = "./output"):
        ...
        self.document_handler = DocumentHandler(timeout=timeout, output_dir=doc_output_dir)
    ...
    def crawl_all(self, urls: List[Dict]) -> List[Dict]:
        ...
        try:
            ...
            print(f"  [WARNING] Event loop issue, applying nest_asyncio: {e}")
            try:
                import nest_asyncio
                nest_asyncio.apply()
            except ImportError:
    ...
    async def download_documents_async(self, documents: List[Dict], output_dir: str, 
    ...
    def download_documents(self, documents: List[Dict], output_dir: str, 
                           notice_title: str = "") -> List[Dict]:
        """同步下载文档
        ...
        try:
            ...
            return asyncio.run(self.download_documents_async(documents, output_dir, notice_title))
        except RuntimeError as e:
    ...
    def generate_html_report(self, output_dir: str = None) -> str:
        """生成HTML报告"""
        try:
            generator = ReportGenerator(self.results, output_dir=output_dir)
...
def main():
    ...
    if args.mode in ["all", "html"]:
        ...
        report_output = os.path.join(args.output, "reports")
